...
//
// sku: viene de item.seller_custom_field (no es un "attribute", es un
// campo propio del ítem). Se usa para el código Costo/Ganancia
// (formato X<costo>Z<ganancia>, con P reemplazando el punto decimal).
// Puede venir null si la publicación no tiene SKU cargado.
