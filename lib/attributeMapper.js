...
// respaldo por si algún día se usa ese campo interno en vez del atributo.
// Se usa para el código Costo/Ganancia (formato X<costo>Z<ganancia>, con P
// reemplazando el punto decimal). Puede venir null si la publicación no
// tiene SKU cargado.
